...
__update_ps1_git_segment() {
  if git rev-parse --is-inside-work-tree &>/dev/null; then
    local branch
    branch=$(__git_ps1 "%s")
    PS1_GIT=$'\033[38;5;208m\033[38;5;232;48;5;208m'"${branch}"$'\033[0;38;5;208m\033[0m'
  else
    PS1_GIT=""
  fi
}
...
PS1="\[\e[38;5;247m\]\[\e[38;5;232;48;5;247m\]\A\[\e[0;38;5;248m\]\[\e[0m\] \
\[\e[38;5;51m\]\[\e[38;5;232;48;5;51m\]\u@\h\[\e[0;38;5;51m\]\[\e[0m\] \
\[\e[38;5;200m\]\[\e[38;5;232;48;5;200m\]\w\[\e[0;38;5;200m\]\[\e[0m\] \
\[\${PS1_GIT}\] \
\n\[\e[0m\]\\\$ "
